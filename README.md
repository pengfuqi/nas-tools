...
[![GitHub stars](https://img.shields.io/github/stars/pengfuqi/nas-tools?style=plastic)](https://github.com/pengfuqi/nas-tools/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/pengfuqi/nas-tools?style=plastic)](https://github.com/pengfuqi/nas-tools/network/members)
[![GitHub issues](https://img.shields.io/github/issues/pengfuqi/nas-tools?style=plastic)](https://github.com/pengfuqi/nas-tools/issues)
[![GitHub license](https://img.shields.io/github/license/pengfuqi/nas-tools?style=plastic)](https://github.com/pengfuqi/nas-tools/blob/master/LICENSE.md)
[![Docker pulls](https://img.shields.io/docker/pulls/pengfuqi/nas-tools?style=plastic)](https://hub.docker.com/r/pengfuqi/nas-tools)
[![Platform](https://img.shields.io/badge/platform-amd64/arm64-pink?style=plastic)](https://hub.docker.com/r/pengfuqi/nas-tools)


Docker：https://hub.docker.com/repository/docker/pengfuqi/nas-tools

TG频道：https://t.me/nastool

WIKI：https://github.com/pengfuqi/nas-tools/wiki
...
### 1、Docker
```
docker pull pengfuqi/nas-tools:latest
```
...
```
git clone -b master https://github.com/pengfuqi/nas-tools --recurse-submodule 
...
https://github.com/pengfuqi/nas-tools/releases
